...
class LeaveConfigurationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $leaves = [
            ...
            //     'can_carry_over' => false,
            //     'can_monetize'   => false,
            //     // Day count intentionally left null — CS Form No. 6 does not specify a
            //     // fixed number of days; duration follows the DSWD-issued Pre-Adoptive
            //     // Placement Authority (PAPA) for the specific adoption case.
            //     'fixed_days'     => null,
            //     'monthly_credit' => null,
            //     'credit_type'    => 'fixed',
